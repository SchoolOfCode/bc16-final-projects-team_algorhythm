...
export default function StudentDashBoard({ data, userData, img }: any) {
      ...
      switch (true) {
        case modulesDone >= 12:
          ...
          achievementsImgs.push(
            "/achievements/module1.png",
            "/achievements/module2.png",
            "/achievements/module3.png",
          );
          break;
        case modulesDone >= 6:
  ...
  return (
    <div className="flex-1 flex flex-col pt-10 px-10 w-full dark:text-black">
      <div className=" flex flex-row md:flex-col justify-between mb-5 ">
      ...
      {!overView && !todo ? (
        <div className="card w-full bg-gradient-to-t from-transparent to-socskyblue">
          <div className=" w-full h-fit gap-6 rounded-t-xl flex md:flex-col items-center p-4 ">
            <img
              ...
              height={100}
            />
            <table className="text-center w-full md:flex md:flex-col table-auto text-lg md:text-sm bg-gradient-to-t from-socskyblue to-white rounded-xl shadow-md dark:to-socskyblue dark:from-transparent">
              <thead>
                <tr className="flex w-full md:order-first justify-between rounded-t-xl">
              ...
              <tbody>
                <tr className="flex w-full justify-between rounded-b-xl dark:text-black">
                  <td className="flex-1">
                    {userInfo.modules > -1
                      ? rank[userInfo.modules]
                      : "Loading..."}
                  </td>
                  <td className="flex-1">
                    {userInfo.leaderboard
                      ? userInfo.leaderboard
                      : userInfo.leaderboard === undefined
                        ? "0"
                        : "Loading..."}
                  </td>
                  <td className="flex-1">
                    {userInfo.modules > -1 ? userInfo.modules : "Loading..."}
                  </td>
                  <td className="flex-1">
                    {userInfo.totalCorrect > -1
                      ? userInfo.totalCorrect
                      : "Loading..."}
                  </td>
          ...
          <div className=" rounded-b-xl p-5  dark:text-white">
            <div className="flex justify-evenly">
              <div className="flex flex-col items-center mb-3 w-[20%]">
                <h2 className="card-title px-2 md:text-sm">
                  Your achievements :
                ...
                <div className="flex flex-wrap gap-2">
                  {achievementsImgs.map((item, key) => (
                    <Image
                      ...
                      width={50}
                      height={50}
                      className=" inline-block bg-white dark:bg-gray-300 rounded-full p-1 shadow-lg border-gray-300 border-solid border"
                    />
                  ))}
                </div>
              </div>
              ...
              <div className="flex flex-col items-center mb-3 w-[20%]">
                ...
                <div className="flex flex-wrap">
                  {userInfo.bestAndWorst
                    ? Number(userInfo.bestAndWorst.worstWeek) !==
                      Number(userInfo.bestAndWorst.bestWeek)
            ...
            <div className="flex justify-around mt-10 text-center">
              <details className="collapse">
                ...
                >
                  <p className="font-bold">Recommended content</p>
                  {!recommended ? (
                    <svg
                      className="animate-bounce w-6 h-6 inline-block "
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                    >
                ...
                <div className="collapse-content">
                  <div className="flex justify-around">
                    <div className="flex flex-col">
                      <h2 className="card-title md:text-md">
                        To elevate your leading area
                      </h2>
                      <p>Some Content...</p>
                    </div>
                    <div className="flex flex-col">
                      <h2 className="card-title">
                        To strengthen your weakest area
                      </h2>
                      <p>Some Content...</p>
                    </div>
                  </div>
            ...
            <div className="card-actions justify-end absolute right-3 bottom-3 ">
              <div className="badge bg-loginblue text-white p-3 cursor-pointer hover:bg-socskyblue hover:text-black rounded-lg">
                Share progress
              </div>
            </div>
          </div>
