  ...
  <footer className="footer p-10 bg-base-300 text-base-content">
      <nav>
       ...
       <nav>
        ...
        <a className="link link-hover">CodeWars</a>
        <a className="link link-hover">Fiddle</a>
        <a className="link link-hover">Exercism</a>
        <a className="link link-hover">Free Code Camp</a>
      </nav> 
      <nav>
