  ...
  useEffect(() => {
    const completed =
      props.results.data.length !== 0
        ? props.results.data
            .filter((item: any) => item.day_number === selected)
            .filter((item: any) => item.success === true)
        : false;
    //console.log(day1)
  }, [selected]);
    ...
    <ul className="steps steps-vertical w-64 pt-2 animate-fade-right">
      <li className="step h-24">
        {selected ? (
          <p
            className={
              selected === 1
                ...
                : "btn btn-ghost bg-gray-300 pointer-events-none"
            }
            onClick={
              selected === 1 ? () => props.setSelected(false) : undefined
            }
          >
            Day 1
          </p>
          ...
          <p
            className="btn btn-ghost bg-socskyblue hover:bg-loginblue"
      ...
      <li className="step h-24">
        {selected ? (
          <p
            ...
            onClick={
              selected === 2 ? () => props.setSelected(false) : undefined
            }
          >
            Day 2
          </p>
      ...
      <li className="step h-24">
        {selected ? (
          <p
            ...
            onClick={
              selected === 3 ? () => props.setSelected(false) : undefined
            }
          >
            Day 3
          </p>
      ...
      <li className="step h-24">
        {selected ? (
          <p
            ...
            onClick={
              selected === 4 ? () => props.setSelected(false) : undefined
            }
          >
            Day 4
          </p>
      ...
      <li className="step h-24">
        {selected ? (
          <p
            ...
            onClick={
              selected === 5 ? () => props.setSelected(false) : undefined
            }
          >
            Day 5
          </p>
