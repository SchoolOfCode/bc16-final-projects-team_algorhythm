...
export default async function Profile({
  ...
  return (
    <div className="flex-1 w-full flex items-center justify-evenly animate-fade md:m-10">
        ...
        <form className="space-y-4 text-center">
          ...
          >
            ...
            <input
              ...
              name="file"
              id="file-upload"
              className="file-input bg-socskyblue dark:text-black file-input-bordered file-input-xs w-full max-w-xs mt-5"
              required
            />
          </label>
          <SubmitButton
