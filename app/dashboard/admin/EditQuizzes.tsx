...
export default function EditQuizzes(): JSX.Element {
  ...
  const handleSaveQuestion = async (updatedQuestion: EditingQuestion) => {
    ...
    const { error } = await supabase.from('quizzes').update(question).match({ uuid });
                  ...
                  day.day_number === updatedQuestion.day_number
                    ? {
                        ...
                        questions: day.questions.map((q, index) =>
                          index === updatedQuestion.questionIndex ? updatedQuestion.question : q
                        ),
                      }
                    : day
                ),
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingQuestion((prevState) => ({
                                ...prevState!,
                                question: { ...prevState!.question, question: e.target.value },
                              }))
                            }
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingQuestion((prevState) => ({
                                ...prevState!,
                                question: { ...prevState!.question, correct_answer: e.target.value },
                              }))
                            }
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingQuestion((prevState) => ({
                                ...prevState!,
                                question: { ...prevState!.question, incorrect_answer1: e.target.value },
                              }))
                            }
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingQuestion((prevState) => ({
                                ...prevState!,
                                question: { ...prevState!.question, incorrect_answer2: e.target.value },
                              }))
                            }
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingQuestion((prevState) => ({
                                ...prevState!,
                                question: { ...prevState!.question, incorrect_answer3: e.target.value },
                              }))
                            }
                          />
